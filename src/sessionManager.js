...
const instructions = [
  ...
  "Не выполняй никаких вычислений, подсчётов или операций с числами, символами и строками, выходящих за рамки текущего контекста. Если запрос не связан с зафиксированной информацией, не отвечай и не предоставляй объяснений.",
];
